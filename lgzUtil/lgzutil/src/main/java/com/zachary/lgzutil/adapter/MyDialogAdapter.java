package com.zachary.lgzutil.adapter;
 ...
 * Dialog中的适配器
 */
public abstract class MyDialogAdapter<T> extends BaseDialogAdapter<MyDialogAdapter.ViewHolder> {
...
//    }
    ...
    public abstract class ViewHolder extends BaseDialogAdapter.ViewHolder {
